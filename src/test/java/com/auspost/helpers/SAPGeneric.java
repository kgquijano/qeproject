...
public class SAPGeneric extends SAPConnection{
    protected ActiveXComponent Obj;
    protected ActiveXComponent session;
    protected ActiveXComponent parentSession;
    ...
    //  public void SAPGUIOKCodeFiled(ActiveXComponent Session, String name, String value) {
    ...
    public int SAPGUITableControlGetVisibleRowCount(String lbl)
    {
        ...
        count = Dispatch.call(session, "VisibleRowCount").getInt();
        return count;
    ...
    {
        Obj = new ActiveXComponent(getSession().invoke("FindById",id).toDispatch());
        int count = ActiveXComponent.call(Obj, "RowCount").getInt();
        for (int i = 0; i < count; i++)
        {
    ...
    public int SAPGuiGridGetRowCount(String partialID) throws Exception
    {
        ...
        Obj = new ActiveXComponent(getSession().invoke("FindById",id).toDispatch());
        int rowCount = Dispatch.call(Obj, "RowCount").getInt();
        return rowCount;
    }
    ...
    public boolean SAPGuiGridCheckValDoubleClickCell(String idstr, String column,String valueToCheck) throws Exception {
        ...
        String id = getSAPObjectIDHelperMethod(getSession(), "ID", idstr, "", "");
        Session = new ActiveXComponent(getSession().invoke("FindById",id).toDispatch());
        int rowCount = Dispatch.call(Session, "RowCount").getInt();
